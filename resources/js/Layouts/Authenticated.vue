        ...
        <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex h-16 justify-between">
                        ...
                        <div class="flex items-center justify-between py-4 px-6 bg-white shadow-md">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <img src="/images/GuessLogo.png" alt="Company Logo"
                                    class="h-12 w-auto rounded-lg shadow-lg">
                                </Link>
           ...
           py-1 px-4 rounded-md shadow-md animate-gradient">
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                <svg class="-me-0.5 ms-2 h-4 w-4" fill="currentColor"
                                                    viewBox="0 0 20 20">
            ...
            <footer class="mt-5 py-4 text-center bg-gray-100 text-gray-700 text-sm">
                &copy; 2025 Server Status Report |
                Developed by <span class="font-semibold">ROBLEDO, John
                    Ronnel Z. - OJT</span>
            </footer>
        </div>
    </div>
